...
- The "Contexte environnemental" tab displays several geographic overlays
 ...
 - A long press (~2&nbsp;s) on the environmental context map opens a pop‑up with
   a "Google Maps" link to the pressed coordinates when released. Dragging or
   zooming the map cancels the timer.
