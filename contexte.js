...
const SERVICES = {
  ...
  natura2000: {
    ...
    buildUrl: (lat, lon) => {
      const base = "https://www.geoportail.gouv.fr/carte";
      return `${base}?c=${lon},${lat}&z=13&l0=ESPACES_NATURELS.NATURA2000::GEOPORTAIL:OGC:WMS(1)&permalink=yes`;
    }
  },
  znieff: {
    name: "ZNIEFF",
    ...
    buildUrl: (lat, lon) => {
      const base = "https://www.geoportail.gouv.fr/carte";
      return `${base}?c=${lon},${lat}&z=13&l0=ESPACES_NATURELS.ZNIEFF::GEOPORTAIL:OGC:WMS(1)&permalink=yes`;
    }
  },
  appb: {
    name: "APPB",
    ...
    buildUrl: (lat, lon) => {
      const base = "https://www.geoportail.gouv.fr/carte";
      return `${base}?c=${lon},${lat}&z=13&l0=ESPACES_NATURELS.APPB::GEOPORTAIL:OGC:WMS(1)&permalink=yes`;
    }
  },
  ens: {
    name: "ENS",
    ...
    buildUrl: (lat, lon) => {
      const base = "https://www.geoportail.gouv.fr/carte";
      return `${base}?c=${lon},${lat}&z=13&l0=ESPACES_NATURELS.ENS::GEOPORTAIL:OGC:WMS(1)&permalink=yes`;
    }
  }
};
